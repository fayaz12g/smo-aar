...
def patch_blarc(aspect_ratio, HUD_pos, unpacked_folder):
    ...
    if aspect_ratio >= 16/9:
        ...
        patch_blyt('MapMini', 'All', 'scale_x', s1) 
        patch_blyt('CounterLife', 'All', 'scale_x', s1) 
        patch_blyt('CounterCoin', 'All', 'scale_x', s1) 
        patch_blyt('CounterCollectCoin', 'All', 'scale_x', s1) 
        patch_blyt('CounterPiece', 'All', 'scale_x', s1) 
        patch_blyt('CounterMiss', 'All', 'scale_x', s1) 
        patch_blyt('CounterShine', 'All', 'scale_x', s1) 
