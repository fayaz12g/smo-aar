...
def patch_blarc(aspect_ratio, HUD_pos, unpacked_folder):
    ...
    if aspect_ratio >= 16/9:
        ...
        if HUD_pos == 'corner':
            ...
            patch_blyt('MapMini', 'RootPane', 'shift_x', 760*s2) 
            patch_blyt('CounterLife', 'RootPane', 'shift_x', 760*s2) 
            patch_blyt('CounterCoin', 'RootPane', 'shift_x', -760*s2) 
            patch_blyt('SaveMessage', 'All', 'shift_x', -760*s2) 
            patch_blyt('CounterCollectCoin', 'RootPane', 'shift_x', -660*s2) 
            patch_blyt('CounterLifeUp', 'RootPane', 'shift_x', 760*s2) 
            patch_blyt('CounterLifeKids', 'RootPane', 'shift_x', 760*s2) 
